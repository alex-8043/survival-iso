...
export const RECIPES: Recipe[] = [
  ...
  { id: 'fishing_rod', name: 'Caña de pescar', out: { item: 'fishing_rod', count: 1 }, ingredients: { stick: 3, string: 2 }, station: 'crafting_table', cat: 'Herramientas' },
  ...
  { id: 'bow', name: 'Arco', out: { item: 'bow', count: 1 }, ingredients: { stick: 3, string: 3 }, station: 'crafting_table', cat: 'Armas' },
  { id: 'arrow', name: 'Flechas ×4', out: { item: 'arrow', count: 4 }, ingredients: { stick: 1, stone: 1, feather: 1 }, cat: 'Armas' },
  ...
  { id: 'leather_legs', name: 'Pantalón de cuero', out: { item: 'leather_legs', count: 1 }, ingredients: { leather: 4 }, station: 'crafting_table', cat: 'Armaduras' },
  { id: 'leather_boots', name: 'Botas de cuero', out: { item: 'leather_boots', count: 1 }, ingredients: { leather: 3 }, station: 'crafting_table', cat: 'Armaduras' },
  ...
  { id: 'iron_legs', name: 'Pantalón de hierro', out: { item: 'iron_legs', count: 1 }, ingredients: { iron_ingot: 7 }, station: 'forge', cat: 'Armaduras' },
  { id: 'iron_boots', name: 'Botas de hierro', out: { item: 'iron_boots', count: 1 }, ingredients: { iron_ingot: 4 }, station: 'forge', cat: 'Armaduras' },
  ...
  { id: 'gold_legs', name: 'Pantalón de oro', out: { item: 'gold_legs', count: 1 }, ingredients: { gold_ingot: 7 }, station: 'forge', cat: 'Armaduras' },
  { id: 'gold_boots', name: 'Botas de oro', out: { item: 'gold_boots', count: 1 }, ingredients: { gold_ingot: 4 }, station: 'forge', cat: 'Armaduras' },
  ...
  { id: 'diamond_legs', name: 'Pantalón de diamante', out: { item: 'diamond_legs', count: 1 }, ingredients: { diamond: 7 }, station: 'forge', cat: 'Armaduras' },
  { id: 'diamond_boots', name: 'Botas de diamante', out: { item: 'diamond_boots', count: 1 }, ingredients: { diamond: 4 }, station: 'forge', cat: 'Armaduras' },
  ...
  { id: 'string', name: 'Cuerda ×2', out: { item: 'string', count: 2 }, ingredients: { wool: 1 }, station: 'crafting_table', cat: 'Construcción' },
